...
import com.androidesk.camera.PhotoAppWidgetProvider.PhotoDatabaseHelper;
...
public class PhotoAppWidgetConfigure extends NoSearchActivity {
	...
	protected void onCreate(Bundle icicle) {
		...
		// This will be slightly too large, but there is not a good way to know
		// the
		// actual widget size from here. The image will be scaled to fit since
		// the layout
