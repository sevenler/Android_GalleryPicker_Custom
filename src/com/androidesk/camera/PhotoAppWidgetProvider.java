...
public class PhotoAppWidgetProvider extends AppWidgetProvider {
	...
	static class PhotoDatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("CREATE TABLE " + TABLE_PHOTOS + " (" + FIELD_APPWIDGET_ID
					+ " INTEGER PRIMARY KEY," + FIELD_PHOTO_BLOB + " BLOB" + ");");
		}
		...
		public Bitmap getPhoto(int appWidgetId) {
			...
			try {
				...
				c = db.query(TABLE_PHOTOS, PHOTOS_PROJECTION, selection, null, null, null, null,
						null);
