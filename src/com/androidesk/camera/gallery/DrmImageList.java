...
public class DrmImageList extends ImageList implements IImageList {
	...
	/*
	 * DrmStore.Images._ID, DrmStore.Images.DATA, DrmStore.Images.MIME_TYPE,
	 */
	"title", "_data", "mime_type" };

	private static final int INDEX_ID = 0;
	private static final int INDEX_DATA_PATH = 1;
	private static final int INDEX_MIME_TYPE = 2;

	public DrmImageList(ContentResolver resolver, Uri imageUri, int sort, String bucketId) {
	...
	private static class DrmImage extends Image {
		...
		protected DrmImage(BaseImageList container, ContentResolver cr, long id, int index,
				Uri uri, String dataPath, long miniThumbMagic, String mimeType, long dateTaken,
				String title, int rotation) {
			super(container, cr, id, index, uri, dataPath, mimeType, dateTaken, title, rotation);
		}
	...
	protected BaseImage loadImageFromCursor(Cursor cursor) {
		...
		return new DrmImage(this, mContentResolver, id, cursor.getPosition(), contentUri(id),
				dataPath, 0, mimeType, 0, "DrmImage-" + id, 0);
	}
}
